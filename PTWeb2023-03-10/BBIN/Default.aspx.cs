...
public partial class BBIN_Default : PageBase
{
...

    {
        ...
        if (this.GridView_Game_Label_tj.Text.Length > 0)

        {

            strSQL = "SELECT * FROM BBGameData where " + this.GridView_Game_Label_tj.Text.Trim() + " and timekey<>'0' ORDER BY JQName,LTIME";
...

        {
            ...
            strSQL = "SELECT * FROM BBGameData where timekey<>'0' ORDER BY JQName,LTIME";
