...
public class DBHelper
{
    ...
    //public DBHelper(string dbSource, string initialCatalog, string userName, string password)
    //{
    //    _connstr = string.Format("Data Source={0};Initial Catalog={1};User ID={2};Password={3};Pooling=true", new object[] { dbSource, initialCatalog, userName, password });
    //}
