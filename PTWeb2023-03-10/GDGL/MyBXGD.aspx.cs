...
public partial class GDGL_MyGD : PageBase
{
    ...
    private void LoadData()
    {
        ...
        // 布线工程
        strSQL = "SELECT GCMC,MAX(W_GCGD1.ID) IID,COUNT(W_GCGD1.ID) MXCOUNT FROM W_GCGD_USERS,W_GCGD1,W_GCGD2,S_YH_QXZ WHERE USERS=" + DefaultUser + " AND FLAG=0 AND W_GCGD1.GCDH=W_GCGD2.GCDH AND W_GCGD1.ID=GCDID and W_GCGD_USERS.USERS=USERID and QXZID=3 GROUP BY GCMC";
