...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-sm-12" runat="server" id="Dtv_HTML">
        ...
        <div>
            ...
            <h4><b>布线分数：</b><asp:TextBox ID="TextBox1" Text="0" Width="50px" runat="server"></asp:TextBox>&nbsp;% 请填写百分比</h4>
            <h4><b>消耗耗材：</b><asp:TextBox ID="TextBox2" Text="0" Width="50px" runat="server"></asp:TextBox>米</h4>
