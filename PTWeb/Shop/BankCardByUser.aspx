    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <h4>
                        <asp:Label ID="Label4" runat="server" Text="姓名"></asp:Label></h4>
                    <h4>
        ...
        <div class="col-xs-12">
            <br />
            <asp:LinkButton ID="LinkButton_Up" OnClick="LinkButton_Up_Click" OnClientClick="return checkPay()" CssClass="btn btn-block btn-success" runat="server"><i class="icon-save"></i>&nbsp;上传付款凭证</asp:LinkButton>
            <br />
        </div>
    </div>
    <%-- 文件上传样式需要--%>
