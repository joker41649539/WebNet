...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="col-xs-12">
        ...
        <div class="clearfix">
            ...
            <div class="grid3">
                <span class="grey">
                    <i class="icon-briefcase icon-2x pink"></i>
                    &nbsp; 卡卷
                </span>
                <h4 class="bigger pull-right">
    ...
    <div class="hr hr8 hr-double"></div>
    <div class="col-xs-12 center" runat="server" id="Div_AppBtn">
        <a href="/Shop/BankCard.aspx" class="btn btn-app btn-warning">
            <i class="icon-credit-card bigger-230"></i>收款账号</a>
        ...
        <a href="/Shop/Recharge.aspx" class="btn btn-app btn-inverse">
