                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <img src="/images/luLogo.png" width="50px" />
                                    <%--  <span class="red"><b>星期陆</b></span>--%>
                                    <span class="white">艾宾浩斯记忆法</span>
                                </h1>
                                <h4 class="blue">&copy; 合肥星期陆电子商务有限公司</h4>
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger">
                                                <img src="/images/luLogo.png" width="25px" />
                                                请输入您的账号密码
                                            </h4>
                                            ...
                                            <%-- <div class="social-or-login center">
                                                <span class="bigger-110">其他应用快捷登录</span>
                                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <asp:TextBox ID="TextBox_LoginName_Reg" class="form-control" placeholder="请输入您的用户名" runat="server"></asp:TextBox>
                                                        <i class="icon-user"></i>
                                                    </span>
                                                </label>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <asp:TextBox ID="TextBox_PassWord_Reg" class="form-control" placeholder="请输入您的密码" type="password" runat="server"></asp:TextBox>
                                                        <i class="icon-lock"></i>
                                                    </span>
                                                </label>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <asp:TextBox ID="TextBox_PassWord2_Reg" class="form-control" placeholder="请输入您的确认密码" type="password" runat="server"></asp:TextBox>
                                                        <i class="icon-retweet"></i>
                                                    </span>
                                                </label>

                                                <label class="block">
                                                    <asp:CheckBox ID="CheckBox1" class="ace" runat="server" />
                                                    <span class="lbl">我同意
															<a href="#">用户协议</a>
                                                    </span>
                                                </label>
