<%@ Page Title="" Language="C#" MasterPageFile="~/XMFight/MasterPage.master" AutoEventWireup="true" CodeFile="BanceAdd.aspx.cs" Inherits="XMFight_Manage_BanceAdd" %>
    ...
    <div class="row page-content height-auto">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">消费类型</label>
                <div class="col-sm-9">
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem Selected="True">支出</asp:ListItem>
